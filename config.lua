Config.PenalCodeTitles = {
    [1] = 'TC PROTI ZIVOTU A ZDRAVI',
    [2] = 'TC PROTI SVOBODE A PRAVUM NA OCHRANU OSOBNOSTI',
    [3] = 'TC PROTI LIDSKE DUSTOJNOSTI V SEXUALNI OBLASTI',
    [4] = 'TC PROTI RODINE A DETEM',
    [5] = 'TC PROTI MAJETKU',
    [6] = 'TC HOSPODARSKE',
    [7] = 'TC OBECNE NEBEZPECNE',
    [8] = 'TC PROTI ZIVOTNIMU PROSTREDI',
    [9] = 'TC PROTI CESKE REPUBLICE',
    [10] = 'TC PROTI PORADKU VE VECECH VEREJNYCH',
}
